...
$REPO_LOGO = "https://raw.githubusercontent.com/LunaMultiplayer/LunaMultiplayer/master/External/Logos/RedFont/LMP_Icon_Medium.png"
...
$DOCFG = "Debug"
$CLIENT_URL = "https://ci.appveyor.com/api/buildjobs/$env:APPVEYOR_JOB_ID/artifacts/KSPMultiplayer-Client-$DOCFG.zip"
$MASTER_SERVER_URL = "https://ci.appveyor.com/api/buildjobs/$env:APPVEYOR_JOB_ID/artifacts/KSPMultiplayerMasterServer-$DOCFG.zip"
...
$WEBHOOK_DATA = "{
  ...
  ""embeds"": [ {
    ...
    ""title"": ""KSP Multiplayer nightly - $BUILD_VERSION - $STATUS_MESSAGE"",
    ""url"": ""$ARTIFACTS_URL"",
    ""description"": ""Debug artifacts: [Client]($CLIENT_URL) · [All artifacts]($ARTIFACTS_URL) — nightly builds may contain bugs."",
    ""timestamp"": ""$TIMESTAMP"",
    ""footer"": {
      ""icon_url"": ""$REPO_LOGO"",
      ""text"": ""KSP Multiplayer (KSPMP)""
    }
  } ]
}"
