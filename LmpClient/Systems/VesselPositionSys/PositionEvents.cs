...
namespace LmpClient.Systems.VesselPositionSys
{
    public class PositionEvents : SubSystem<VesselPositionSystem>
    {
        ...
        /// <summary>
        /// Broadcast orbit and body data immediately when taking control so the server does not
        /// have to wait for the next timed position send to refresh the vessel's location context.
        /// </summary>
